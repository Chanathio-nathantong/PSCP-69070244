...
3071 [Learning Log]จำนวนในช่วง [A,B] ที่หารด้วย d เหลือเศษ r
...
รับค่าตัวเลขเข้ามา 2 ตัว จะเป็นตัวเลขที่กำหนดช่วงของตัวเลข รับค่าอีกตัวเข้ามาเป็นตัวหาร และรับค่าเข้ามาอีกตัวเป็นเศษ จากนั้นนำช่วงตัวเลขสองตัวเลขมาหารหาเศษด้วย ตัวหารที่รับเข้ามาให้ได้เศษที่รับเข้ามาตัวสุดท้าย จากนั้นนับว่ามีตัวที่หารแล้วได้เศษที่ที่ต้องการกี่ตัว และแสดงผลลัพธ์ออกมา
...
```text
Step 1:รับค่าตัวเลขเข้ามา 2 ตัวเพื่อกำหนดช่วงของตัวเลข
Step 2:รับค่าตัวเลขเพื่อเป็นตัวหาร d และรับค่าตัวเลขอีกตัวเพื่อเป็นเศษ
Step 3:จากนั้นเอาช่วงตัวเลขมาหารด้วย d ที่มีเศษเท่ากับ r
step 4:จากนั้ แสดงว่ามีตัวอะไรบ้าง
```
...
ต่างจากวิธีแรีกเพราะมีการเข้าใจผิดในเรื่องของการแสดงผลลัพธ์ โดยตอนแรกเข้าใจว่าต้องแสดงตัวที่หารลงตัว แต่เมื่ออ่านใหม่อีกทีจึงรู้ว่าโจทย์ต้องการทราบว่ามีกี่ตัวในช่วงของจำนวนที่หาร d แล้วได้เศษ r
...
กรณ๊ที่ตัวหารติดลบ แต่เศษไม่ติดลบ

...
รับค่าข้อความเข้ามา จากนั้นเช็คแต้มของไพ่จากจากตัวอักษรตัวหน้า และเช็คสัญลักษณ์ของไพ่จากตัวอักษรตัวหลัง และแสดงผลออกมาโดยแต้มอยู่ด้านหน้า มี of คั่นกลาง และตามด้วยสัญลักษณ์ และเว้นวรรค
...
Step 2:เช็คแต้ม และสัญลักษณ์ของไพ่
Step 3:แสดงผลโดยแต้ใของไพ่อยู่ด้านหน้า และมี of คั่นกลางตามด้วยสัญลักษณ์ และมีการเว้นวรรคระหว่างคำ
```
...
เหมือนกับวิธีแรก เพราะรับค่าเข้ามาแล้วก็โชว์แต้มและสัญลักษณ์ของไพ่
...
กรณีที่ตัวอักษรเป็นตัวพิมพ์เล็ก
...
กรณที่มีตัวเลขที่ไม่อยุ่ในเงื่อนไข

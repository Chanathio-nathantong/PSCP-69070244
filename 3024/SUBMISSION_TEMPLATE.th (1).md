...
รับค่าตัวเลขเข้ามาสองค่าโดยจะเป็นค่าคะแนนรวมทั้งหมด และค่าคะแนนที่สูงที่สุด จากนั้นให้เอาค่าคะแนนสูงสุดกับต่ำสุดมาเปรียบเทียบกันว่า หากคะแนนห่างกันเกินมากกว่า 2 คะแนนให้แสดงคำว่า Surprising แต่หากไม่เกิน 2 คะแนนให้แสดงคำว่า Not surprising
...
```text
Step 1:รับค่าเข้ามาทั้งสองค่า
Step 2:นำค่าทั้งสองมาหาค่าที่ต่ำที่สุด
Step 3:จากนั้นนำเข้าเงื่อนไข และแสดงผลออกมา
```
...
เหมือนกับวิธีแรก รับค่าเข้ามาหากค่าต่ำสุด เปรียบเทียบกันเข้าเงื่อนไขและแสดงผล
...
กรณีที่ค่าคะแนนรวมน้อยกว่าคะแนนสูงสุด
...
ช่วยแนะนำแนวทางในการหาค่าต่ำสุด

คุณยังทำอะไรด้วยตนเอง

ทำเงื่อนไขและการแสดงผล

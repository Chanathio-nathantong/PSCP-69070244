...
มีการรับค่าข้อความ โดยเมื่อรับค่าเข้ามาไม่ว่าจะเป็นตัวพิมพ์เล็กหหรือตัวพิมพ์ใหญ่ ให้เปลี่ยนทั้งหมดเป็นตัวพิมพ์เล้กทั้งหมด และนำค่าข้อมูลที่รับเข้ามามาแสดงผลลัพธ์แบบกลับหลังจากหลังมาหน้า และแสดงผลลัพธ์
...
Step 1:รับค่าข้อความตักอักษร
Step 2:นำข้อความที่รับเข้ามาใช้ .lower() เพื่อที่จะทำเป็นตัวอักษรพิมพ์เล้กทั้งหมด
Step 3:นำข้อความที่ทำเป็นตัวพิมพ์เล้กแล้ว มาทำการแสดงผลลัพธ์แบบกลับหลัง โดยที่เริ่มจากตัวสุดท้ายมายังตัวหน้าสุด
...
เขียนเหมือนกับแผนแรก เพราะเราทำการรับค่าข้อความและปรับเป็นตัวเล้ก จากนั้นก็กลับผลลัพธ์จากหลังมาหน้า
...
กรณีรับค่าข้อความเป็นชื่อจริงและนามสกุลโดยที่มีการเว้นวรรคระหว่าง ชื่อและนามสกุล

Input:

Chanathip Nathantong

Expected output:

gnotnahtan pihtanahc
...
กรณีไม่ใส่ข้อความอะไรเลยกด Enter เลย

...
รับค่าข้อความเข้ามา จากนั้นเช็คว่าในข้อความว่ามี A-E-I-U-O ในข้อความนั้นหรือไม่ และถ้าหากมีมีอย่างละกี่ตัว จากนั้นแสดงผลออกมาว่า ในข้อความที่รับเข้ามามีสระอะไรบ้าง และสระที่มีมีกี่ตัว โดยแสดงเฉพาะสระที่มีในข้อความนั้นเท่านั้น
...
```text
Step 1:รับค่าข้อความเข้ามา
Step 2:เช็คว่าข้อความที่รับเข้ามามีสระอยู่หรือไม่
Step 3:เช็คว่าหากมีสระในข้อความที่รับเข้ามา มีสระอย่างละกี่ตัว
step 4:แสดงผลออกมาว่ามีสระอะไรบ้าง และแสดงเฉพาะสระที่มีพร้อมกับบอกว่ามีกี่ตัว 
...
เหมือนกับวิธีแรก โดยเรารับค่าเข้ามาแล้วก็เช็คว่ามีสระอยู่หรือไม่ ถ้ามีมีสระอะไรบ้าง อย่างละกี่ตัว
...
กรณีที่ไม่มีสระอยู่ในข้อความเลย
...
กรณีที่เขียนสลับตัวใหญ่และตัวเล็ก

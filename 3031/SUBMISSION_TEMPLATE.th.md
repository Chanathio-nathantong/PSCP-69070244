...
รับค่าอัตราการไหลของหมึกเข้ามา แล้วก้รับจำนวนบ้านเข้ามาในบรรทัดเดียวกันและเว้นวรรค จากนั้นก็รับพิกัดบ้านเข้ามา จากนั้นก็เอาเอามาหารัศมีวงกลมด้วย r^2 = x^2 + y^2 เอามาหาพื้นที่คูณกับค่า pi ที่ให้มา จากนั้นก็เอาพื้นที่มาการด้วยอัตราการไหลเพื่อหาระยะเวลาที่จะไหลไปถึงพิกัด และแสดงผลออกมา
...
```text
Step 1:รับค่าอัตราการไหล และจำนวนบ้าน และสร้าง list เพื่อเก็บค่าคำตอบ
Step 2:ทำ for loop รับค่าพิกัดของบ้านแต่ละหลัง
Step 3:นำมาดำเนินการทางคณิตศาสตร์ 3.1416(x^2 + y^2) เพื่อหาพื้นที่ และนำมาหารด้วยอัตราการไหล
Step 4:นำคำตอบมาใช้ math.ceil() เพื่อปัดเศษ และนำไปเก็บไว้ใน list
Step 5:สร้าง loop อีกอันนึงเพื่อนำมาแสดงผลของคำตอบทีละบรรทัดแบบขึ้นบรรทัดใหม่
```
...
เหมือนกับวิธีแรก เพราะรับค่าเข้ามา นำมาดำเนินการทางคณิตศาสตร์ ปัดเศษ และแสดงผลออกมา
---

...
| OJ submission ID, if submitted | 544707 |
| OJ status | Pass |
...
My answer:ฉันถาม ai ให้ช่วยประเมินแผนแรกของฉันและข้อบกพร่องในโค้ดของฉันในการหาราคาที่ต้องจ่ายในหารกินอาหารครั้งนี้
...
My answer:ai ช่วยฉันสังเกตเกี่ยวกับโจทย์ว่าฉันมองข้ามไปในกรณีที่ราคาอาหารเมื่อนำมาหาค่าบริการแล้วไม่ถึง 50 หรือ เกิน 1000 ตามที่โจทย์กำหนด จะทำการปรับค่าบริการเป็น 50 หรือ 1000 เลย และยังช่วยฉันสังเกตลำดับการเีขยนของฉันว่าถูกต้องหรือไม่ หากรันโค้ดแล้วต้องเข้าเงื่อนไข มันจะเป็นไปตามเงื่อนไขหรือไม่
...
My answer:ฉันตรวจสอบเงื่อนไขของค่าบริการใหม่รวมทั้งปรับเปลี่ยนโค้ดใหม่ให้เข้าใจง่ายขึ้นกว่าเดิม ได้แก้เงื่อนไขค่าบริิการ และเช็คโค้ดว่าเป็นไปตามที่โจทย์ต้องการหรือไม่
...
My answer:ได้เรียนรู้การอ่านโจทย์และตีโจทย์ให้แตก ว่าโจทย์ต้องการอะไรและกำหนดเงื่อนไขอะไรมาบ้าง อีกทั้งยังช่วยให้คำแนะนำในการปรับเขียนโค้ดให้มีความเข้าใจง่ายขึ้นกว่าเดิมอีกด้วย

...
รับค่าบอลอาหาร โดยที่กำหนดค่าบริการ 10% จากราคาของค่าอาหาร แต่ร้านมีข้อกำหนดว่าจะมีค่าบริการขั้นต่ำอย่างน้อย 50 แต่ไม่เกิน 1000 คือถ้าราคาอาหารคูณกับค่าบริการไม่เกิน 50 ค่าบริการก็จะคิดเป็น 50 แต่หากราคาอาหารคูณกับค่าบริการแล้วเกิน 1000 ก็จะคิดค่าบริการแค่ 1000 อีกทั้งเมื่อรวมค่าอาหารและค่าบริการแล้วต้องเอามาคิดค่า vat7% ด้วยจากนั้นแสดงผลลัพธ์ที่รวมทั้งค่าอาหารและค่าบริการและ vatเรียบร้อยแล้ว พร้อมทั้งแสดงเป็นเลขจุดทศนิยม 2 ต่ำแหน่ง
...
Step 1:รับค่าอาหารทั้งหมด
Step 2:นำค่าอาหารมาคิดราคาค่าบริการตามเงื่อนไข
Step 3:นำราคาอาหารรวมกับค่าบริการมาหาค่า vat
step 4:แสดงผลลัพธ์ค่าอาหารรวมทั้งค่าบริการและค่า vat และทำให้เป็นเลขจุดทศนิยม 2 ตำแหน่ง

ก่อนถาม ai ฉันรู้อยู่แล้วว่าขั้นตอนการเขียนโค้ด และสิ่งที่โจทย์ต้องการและขั้นตอนการทำงานมันเป็นยังไง แต่เมื่อรันแล้วยังมีบาง testcase ที่ไม่ผ่านเลยถาม ai ให้ประเมินโค้ดว่ามีจุดไหนที่บกพร่อง
...
ใช้วิธีตามแผนแรก แต่มีการปรับเปลี่ยนการเขียนหลังจากให้ ai ประเมินโค้ดให้คือมีจุดบกพร่องในจุดที่คิดคำนวนค่าบริการ ในตอนแรกคิดค่าบริการตอนแรกที่เขียนคือกำหนดค่าบริการอย่างน้อย 50 ไม่เกิน 1000 แต่ลืมที่จะเอาค่าบริการ 10% มาคิดในการหาค่าบริการ หลังจากนั้นก็ทำตามแผนแรก
...
กรณีค่าอาหารน้อยกว่าค่าบริการขั้นต่ำ
...
กรณีที่ใส่ค่าอาหารเป็นค่าติดลบ
...
ฉันเขียนแผนแรกด้วยตนเองจนเสร็จ แต่เมื่อพบว่ามันมีจุดบกพร่องฉันเลยค้นหาจุดบกพร่องด้วยตนเองอยู่นานกว่า 10 นาทีฉันจึงให้ ai ช่วยประเมินโค้ดให้และหาว่าจุดบกพร่องอยู่ตรงไหน

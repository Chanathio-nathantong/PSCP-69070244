...
รับค่า ฉลากที่ถูกรางวัลเข้ามา แต่รับค่าฉลากที่ซื้อ จากนั้นก็นำมาเข้าเงื่อนไขของการถูกรางวัล และแสดงรางวัลที่ได้
...
```text
Step 1:รับค่าฉลากที่ถูก และค่าฉลากที่ซืัอ
Step 2:นำมาเข้าเงื่อนไขของการถูกรางวัล
Step 3:แสดงจำนวนเงินรางวัลที่ได้
```
...
ทำเหมือนวิธีแรก เพราะแค่รับค่าเข้ามา แล้วนำมาเข้าเงื่อนไข และแสดงผลออกมา
...
กรณีที่ตัวอักษรเหมือน แต่ตัวเลขเหมือนกันแค่ 3 ตัวหน้า
...
กรณีที่ถูกตัวเลขท้ายแค่ตัวเดียว
...
กรณีที่ตัวอักษรไม่ใช่ตัวอักษรภาษาอัวกฤษ

...
รับค่าอุณหภูมิในปัจจุบันเข้ามา และบรรทัดต่อมาระบุว่าเป็นหน่วยอุณหภูมิอะไร องศาเซลเซียส องศาโรเมอร์ องศาฟาเรนไฮต์ เคลวิน และบรรทัดสุดท้ายคือรับค่าเข้ามาว่าต้องการให้เปลี่ยนจากหน่วยไหนไปเป็นหน่วยไหน และแสดงผลออกมาโดยมีจุดทศนิยม 2 ตำแหน่ง
...
```text
Step 1:รับค่าอุณหภูมิปัจจุบันเข้ามา และรับค่าหน่วยของอุณหภูมิปัจจุบัน และรับค่าหน่วยอุณหภูมิที่ต้องการเปลี่ยนไป
Step 2:นำค่าที่รับเข้ามามาคำนวนทางคณิตศาสตร์เพื่อหาค่าของอุณหภูมิที่เปลี่ยนแปลงไป
Step 3:จากนั้นแสดงผลออกมา
```
...
เหมือนกับวิธีแรก รับค่าเข้ามาและเข้าเงื่อนไขในการเลือกสูตรคำนวนทางคณิตศาสตร์ และแสดงผลออกมา
...
กรณีที่เลือกหน่วยอุณหภูมิเหมือนกัน
...
กรณีที่ใส่หน่วยอุณหภูมิที่ไม่มีที่กำหนด

...
รับค่าเดือนในบรรทัดแรกเป็นตัวเลข และรับค่าวันเป็นตัวเลขในบรรทัดที่สอง จากนั้นรนำมาเข้าเงื่อนไขของฤดู หากเป็นเดือนที่สามของฤดู และวันเกินวันที่ 21 ให้เปลี่ยนเป็นฤดูถัดไป และแสดงผลลัพธ์ออกมา
...
```text
Step 1:รับค่าเดือนและวัรเป็นตัวเลขแบบขึ้นบรรทัดใหม่
Step 2:นำเข้าเงื่อนไขในการหาฤดู
Step 3:แสดงผลลัพธ์
```
...
เหมือนกับวิธีแรก เพราะรับค่าเดือนและวันจากนั้นนำเข้าเงื่อนไขและแสดงผลลัพธ์

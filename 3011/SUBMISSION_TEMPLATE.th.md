...
ทำการรับค่าสีมา 2 สีโดยที่มีเงื่อนไขแม่สีดังนี้ :
ถ้าสีแดงผสมกับสีเหลือง จะได้สีส้ม
ถ้าสีแดงผสมกับสีน้ำเงิน จะได้สีม่วง
ถ้าสีเหลืองผสมกับสีน้ำเงินจะได้สีเขียว
ถ้าผสมสีด้วยตัวของมันเอง ก็จะได้สีเดิม
ถ้าหากรับค่าสีที่ไม่มีในเงินไขที่กล่าวมาจะให้แสดงค่า Error
...
Step 1:รับค่าสีมา 2 สอง
Step 2:นำสองสีมาผสมกันตามเงื่อนไข
Step 3:เช็คกรณีเงื่อนไขของการผสมสี
step 4:เช็คกรณีผสมสีตัวของมันเอง
step 5:แสดงผลลัพธ์ของการผสมสี
step 6:หากค่าสีที่เข้ามาเป็นสีที่ไม่ใช่แม่สีตามเงื่อนไข ให้แสดงคำว่า Error
...
ใช้เงื่อนไขการผสมสีของแม่สี ในการผสมสีรวมทั้งผสมสีตัวของมันเอง และแสดงเป็นผลลัพธ์ออกมา หากร่าค่าสีที่ไม่มีในแม่สี ให้แสดงว่า Error
...
กรณีรับค่าสี Brown ผสมกับสี Violet
...
กรณีนำแม่สี มาผสมกับสีที่ผสมแล้ว

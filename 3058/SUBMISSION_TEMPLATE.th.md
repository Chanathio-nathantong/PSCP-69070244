...
รับค่าเข้ามา 3 ค่า โดยที่ค่าแรกคือจำนวนของอิฐ a และค่าที่ 2 คือจำนวนของอิฐ b และค่าที่ 3 คือระยะของสะพานโดยอิฐ a มีความยาว 1 นิ้ว และอิฐ b มีความยาว 5 นิ้ว โดยโจทย์ต้องการให้สร้างสะพานโดยบอกจำนวนอิฐ a ที่ใช้ในการสร้างสะพาน หากว่าเพียงพอให้บอกจำนวนอิฐ a ที่ใช้ไป แต่หากไม่พอให้แสดง -1
...
```text
Step 1:รับค่าเข้ามา 3 ค่าแทน a, b และ goal
Step 2:นำค่าที่รับเข้ามาหาจำนวนอิฐ a ที่ต้องใช้
Step 3:แสดงจำนวนอิฐ a ที่ต้องใช้ หากอิฐ a ไม่พอให้แสดง -1
```
...
เหมือนกับแผนแรก เพราะนำค่าที่รับเข้ามา มาหาจำนวนของอิฐ a ที่ใช้และแสดงจำนวนนั้นออกมา แต่หากจำนวนอิฐ a ที่รับเข้ามาไม่พอกับที่ต้องการใช้งานให้แสดง -1
...
รับค่าจำนวนอิฐ b มาพอดีกับความยาวของสะพานที่ต้องการและรับค่าอิฐ a มา 0 

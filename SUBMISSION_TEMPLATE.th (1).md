...
3024 [Learning Log] SurprisingVote
...
รับค่าคะแนนรวมของผู้เข้าแข่งขันทั้งสามคนในบรรทัดแรก และรับค่าคะแนนผู้เข้าแข่งขันที่มากที่สุดในบรรทัดที่สอง จากนั้นเข้าเงื่อนไขที่โจทย์ให้มา ว่าถ้าหากคะแนนของผู้เข้าแข่งขันที่ได้คะแนนมากที่สุดห่างจากผู้เข้าแข่งขันที่ได้คะแนนต่ำที่สุดเกิน 2 คะแนนให้ให้แสดงผลลัพธ์ Surprising ถ้าไม่เกิน 2 คะแนนให้ปริ้น Not surprising
...
step1 รับค่าเข้ามาสองบรรทัดโดยที่บรรทัดแรกเป็นคะแนนรวม บรรทัดที่สองเป็นคะแนนที่สูงที่สุด
step2 นำมาหาค่าคะแนนกลางและค่าคะแนนต่ำที่สุด
step3 นำคะแนนสูงสุดกับต่ำสุดมาลบกับ หากมากกว่า 2 ให้แสดง Surprising หากไม่เกิน 2 ให้แสดง Not surprising
...
step1 รับค่าเข้ามาสองบรรทัดโดยที่บรรทัดแรกเป็นคะแนนรวม บรรทัดที่สองเป็นคะแนนที่สูงที่สุด
step2 หาค่าคะแนนที่ต่ำที่สุด
step3 นำมาดเข้าเงื่อนไขถ้าห่างกันมากกว่า 2 แสดง Surprising ถ้าไม่ให้แสดง Not surprising
...
ช่วยในการหาค่าคะแนนที่ต่ำที่สุด

คุณยังทำอะไรด้วยตนเอง

เขียนรับค่า เงื่อนไข และคิดหา testcase

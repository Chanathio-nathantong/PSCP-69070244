...
รับค่าระยะที่กระโดด x และระยะทาง y โดยที่ x การกระโดครั้งต่อไปลดลงทีละ 2 แล้วให้บอกว่ากระโดดไปกี่ครั้ง แต่ถ้ากระไดดไม่ถึง ให้แสดง -1
...
```text
Step 1:รับค่า x, y 
Step 2:นำค่า x, y มาทำ while loop
Step 3:โดยการกระโดดแต่ละครั้ง x จะลดลง 2 และสร้างตัวแปรนับจำนวนครั้งที่กระโดด
Step 4:แสดงผลจำนวนการกระโดดออกมา แต่หากกระโดดไปไม่ถึงให้แสดง -1
```
...
เหมือนกับวิธีแรก เพราะรับค่าเข้ามานำเข้า loop จากนั้นก็แสดงผล

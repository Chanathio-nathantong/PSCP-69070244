...
รับค่าตัวเลขเข้ามาเป็นจำนวนเต็ม นำมาหารด้วย 10 จากนั้นก็แสดงผลที่ช่วงตั้งแต่ 0 จนถึงตัวเลขที่รับค่าเข้ามาที่หารด้วย 10 ลงตัวแสดงผลจากค่ามากสุดที่หารลงตัวไปหาค่าที่น้อยที่สุด
...
```text
Step 1:รับค่าตัวเลขเข้ามาเป็นจำนวนเต็ม
Step 2:นำมาหารแบบหาเศษด้วย 10 
Step 3:แสดงผลตัวเลขที่หารด้วย 10 ลงตัว โดยไล่จากค่ามากไปน้อย
```
...
เหมือนกับแผนแรก เพราะเพียงแค่รับค่าเข้ามาหารหาเศษด้วย 10 และแสดงผล
